...
module.exports = {
    scripts: {
        ...
        setup_prod: {
            ...
            description: 'Setup`s the production environment(yarn & database)'
        },
        /**
        ...
        db: {
            ...
            setup: {
                script: series(
                    'nps db.drop',
                    'nps db.migrate',
                    runFast('./src/database/seeds/init/01-InitCategory.ts'),
                    runFast('./src/database/seeds/init/02-InitLocation.ts'),
                    runFast('./src/database/seeds/init/03-InitCertification.ts'),
                    runFast('./src/database/seeds/init/04-InitTargetType.ts'),
                    // runFast('./src/database/init/InformationSpecial.ts'),
                    // runFast('./src/database/init/CategorySub1InformationSpecial.ts'),
                    'nps db.seed',
                    // runFast('./src/database/seeds/update/1-UpdatePostProductReacts.ts'),
                    // runFast('./src/database/seeds/update/2-UpdatePostProductProcesses.ts'),
                ),
            ...
            setup_prod: {
                script: series(
                    'nps db.drop',
                    'nps db.migrate',
                    // runFast('./src/database/init/Category.ts'),
                    // runFast('./src/database/init/CategorySub1Communicate.ts'),
                    // runFast('./src/database/init/InformationSpecial.ts')
                )
            }
        },
